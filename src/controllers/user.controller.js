...
const loginUser = asyncHandler(async (req, res) => {
    ...
    // console.log('Req.file.avatar[0].path --- ',req.file.avatar[0].path);
...
const changeCurrentPassword = asyncHandler(async (req, res) => {
    ...
    // validate old password via isPasswowrdCorrect
    ...
    if (newPassword !== confirmNewPassword) {
        throw new ApiError(
            400,
            "New Password should be same as Confirm New Password"
        );
    }
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
    ...
    await deleteImageFromCloudinary(oldUser.coverImage);
