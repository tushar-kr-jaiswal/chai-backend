...
userSchema.methods.generateAccessToken = async function () {  // for short period of time
    jwt.sign(
        {
            _id: this._id,
            email: this.email,
...
userSchema.methods.generateRefreshToken = async function () {  // for longer period of time
    jwt.sign(
        {
            _id: this._id,
        },
